...
class DemoShowcaseTest {
    ...
    void showcase() {
        ...
        // 4) Модификация: выключаем active только у id=33
        ...
        // 5) Модификация: delete по фильтру
